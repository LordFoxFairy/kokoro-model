...
export const modelAdminContract: {
  ...
  routes: [
    ...
    { method: "POST", route: "/admin/models/provider-accounts/:id/health" },
    ...
    resources: [
      {
        ...
        actions: [
          ...
          {
            id: "health",
            labelKey: "admin.model.actions.updateProviderHealth",
            kind: "mutation",
            requiredPermission: "model.providerAccount.health",
            route: "/admin/models/provider-accounts/:id/health",
            method: "POST",
          },
        ],
      },
